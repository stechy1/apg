...
import cz.pstechmu.apg.util.QuaternionUtil;
...
public class Camera {
    ...
    public Camera(Matrix4f projection) {
        ...
        forward = new Vector3f(AXIS_Z).negate();
    ...
    public Camera(final Camera other) {
        ...
        this.orientation = new Quaternionf(other.orientation);
    ...
    public void update() {
        ...
        view.translate(position.negate(), view);
    }
    ...
    private void rotate(Vector3f axis, Vector3f v1, Vector3f v2, float angle) {
        Quaternionf rotation = QuaternionUtil.createFromAxisAngle(axis, angle, null);
        rotation.mul(orientation, orientation);
//        Quaternionf.mul(rotation, orientation, orientation);
    ...
    public Camera copy() {
        ...
        res.orientation = new Quaternionf(this.orientation);
